function Truss25InpFileConstr1(x)
%
...
%
% Description
%     This function creates the input file "Truss25ABAQUS1.inp" which is
...
OutputFileName = 'Truss25ABAQUS1.inp';
...
fprintf(fileID,' 1,2,10.\n');
fprintf(fileID,' 1,3,-5.\n');
fprintf(fileID,' 2,1,0.\n');
fprintf(fileID,' 2,2,10.\n');
fprintf(fileID,' 2,3,-5.\n');
fprintf(fileID,' 3,1,0.5\n');
fprintf(fileID,' 3,2,0.\n');
fprintf(fileID,' 3,3,0.\n');
fprintf(fileID,' 6,1,0.5\n');
fprintf(fileID,' 6,2,0.\n');
fprintf(fileID,' 6,3,0.\n');
